...
#Region "Constructores"
    Public Sub New(ByVal pRuta As String, ByVal pCreacion As Date, ByVal pModificacion As Date, ByVal pUltimoAcceso As Date)
        MyBase.New(pRuta, 0, Nothing)
        Creacion = pCreacion
...
#Region "Metodos"
    Public Overrides Function CompareTo(ByVal obj As Object) As Integer
        Dim aux As Integer
        Dim objc As ArchivoDirDN

        If Not Me.Comparable(obj) Then
            Return 0
        End If

        objc = CType(obj, ArchivoDirDN)
