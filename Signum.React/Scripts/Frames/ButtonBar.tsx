...
import { TypeContext, StyleOptions, EntityFrame, RenderButtonsComponent, ButtonsContext } from '../TypeContext'
...
export default class ButtonBar extends React.Component<ButtonBarProps, void>{
    ...
    render() {
        ...
        var c = ctx.frame.component as any as RenderButtonsComponent;
