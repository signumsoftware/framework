        ...
        <div className="form-inline">
          {(p.pagination.mode == "All" ? SearchMessage.PaginationAll_0Elements :
            ...
            .niceToString().formatHtml(
              ...
              <select value={p.pagination.mode} onChange={handleMode} className="form-select form-control-xs d-inline-block w-auto sf-pagination-mode">
                ...
                <select value={p.pagination.elementsPerPage!.toString()} onChange={handleElementsPerPage} className="form-select form-control-xs d-inline-block w-auto sf-elements-per-page">
