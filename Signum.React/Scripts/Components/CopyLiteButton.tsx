...
export default function CopyLiteButton(p: CopyLiteButtonProps) {
  ...
  return (
    <span className={p.className}>
      <a ref={link} className="btn btn-sm bg-light text-dark sf-pointer mx-1" onClick={handleCopyLiteButton} title={NormalControlMessage.CopyEntityTypeAndIdForAutocomplete.niceToString()} >
