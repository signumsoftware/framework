...
declare namespace React {
    ...
    class Component<P, S> {
        ...
        readonly props: { children?: ReactNode } & P;
        state: S;
        /**
         * @deprecated
    ...
    type GetDerivedStateFromProps<P, S> =
         ...
         */
        (nextProps: P, prevState: S) => Partial<S> | null;
    ...
    function memo<P extends object>(
        Component: SFC<P>,
        propsAreEqual?: (prevProps: P & { children?: ReactNode }, nextProps: P & { children?: ReactNode }) => boolean
