...
declare namespace ReactBootstrap {
    ...
    // <Panel.Title />
    interface PanelTileProps extends React.HTMLProps<PanelTitle> {
        componentClass?: string;
        toggle?: boolean;
        bsClass?: string;
    }
    class PanelTitle extends React.Component<PanelTileProps> {
    }
    ...
    class PanelToggle extends React.Component<PanelToggleProps> {
    }

    // <Panel.Collapse />
    interface PanelCollapseProps extends TransitionCallbacks, React.HTMLProps<PanelCollapse> {
        bsClass?: string;
    }
    class PanelCollapse extends React.Component<PanelCollapseProps> {
    }
    ...
    interface PanelClass extends React.ClassicComponentClass<PanelProps> {
        Heading: typeof PanelHeading;
        Title: typeof PanelTitle;
        Toggle: typeof PanelToggle;
        Collapse: typeof PanelCollapse;
