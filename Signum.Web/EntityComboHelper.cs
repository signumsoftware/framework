...
namespace Signum.Web
{
    ...
    public static class EntityComboHelper
    {
        internal static string InternalEntityCombo(this HtmlHelper helper, string idValueField, Type type, object value, EntityCombo settings)
        {
            ...
            if (settings.View)
            {
                string viewingUrl = "javascript:OpenPopup('{0}','{1}','{2}',function(){{OnPopupComboOk('{3}','{2}');}},function(){{OnPopupComboCancel('{2}');}});".Formato("Signum/PopupView", divASustituir, idValueField, "Signum/ValidatePartial");
            ...
            if (settings.Create)
            {
                string creatingUrl = "javascript:NewPopup('{0}','{1}','{2}',function(){{OnPopupComboOk('{3}','{2}');}},function(){{OnPopupComboCancel('{2}');}});".Formato("Signum/PopupView", divASustituir, idValueField, "Signum/ValidatePartial", (typeof(EmbeddedEntity).IsAssignableFrom(type)));
                sb.AppendLine(
