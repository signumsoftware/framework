...
(function (SF) {
    (function (FindNavigator) {
        ...
        FindNavigator.findMany = findMany;
        ...
        })(FindNavigator.ColumnOptionsMode || (FindNavigator.ColumnOptionsMode = {}));
        var ColumnOptionsMode = FindNavigator.ColumnOptionsMode;
        ...
        FindNavigator.FilterMode = FilterMode;
        ...
        var SearchControl = (function () {
            ...
            SearchControl.prototype.selectedItems = function () {
                ...
                selected.each(function (i, v) {
                    ...
                    var val = new SF.EntityValue(new SF.RuntimeInfoValue(parts[1], parseInt(parts[0])), parts[2], $(this).parent().next().children('a').attr('href'));
            ...
            SearchControl.prototype.onCreate = function () {
                ...
                if (this.creating != null)
                    ...
                    this.getEntityType().then(function (type) {
                        ...
                        var runtimeInfo = new SF.RuntimeInfoValue(type, null);
                        if (SF.isEmpty(_this.options.prefix))
                            SF.ViewNavigator.navigate(runtimeInfo);
                        else
                            SF.ViewNavigator.navigatePopup(new SF.EntityHtml(SF.compose(_this.options.prefix, "Temp"), runtimeInfo));
                    });
            };
        ...
        FindNavigator.SearchControl = SearchControl;
