namespace Signum.Excel
{
    ...
    public sealed class PageHeader : IWriter, IReader, IExpressionWriter
    {
        ...
        {
            writer.WriteStartElement(Namespaces.ExcelPrefix, "Header", Namespaces.Excel);
            if (this._data != null)
            {
        ...
        {
            return UtilXml.IsElement(element, "Header", Namespaces.Excel);
        }
