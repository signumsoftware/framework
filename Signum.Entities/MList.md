...
That's it!. In the UI you can use a normal `EntityTable` but when you remove an element in the Lines MList and save, the `OrderLineEntity` will be deleted from the database. 
