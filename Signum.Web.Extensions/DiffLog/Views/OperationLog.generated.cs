...
namespace Signum.Web.DiffLog.Views
{
    using System;
...
WriteAttributeTo(__razor_template_writer, "class", Tuple.Create(" class=\"", 5722), Tuple.Create("\"", 5796)
, Tuple.Create(Tuple.Create("", 5730), Tuple.Create("glyphicon", 5730), true)
, Tuple.Create(Tuple.Create(" ", 5739), Tuple.Create("glyphicon-step-forward", 5740), true)
, Tuple.Create(Tuple.Create(" ", 5762), Tuple.Create("colorIcon", 5763), true)
, Tuple.Create(Tuple.Create(" ", 5772), Tuple.Create("red", 5773), true)
            
            #line 151 "..\..\DiffLog\Views\OperationLog.cshtml"
, Tuple.Create(Tuple.Create(" ", 5776), Tuple.Create<System.Object, System.Int32>(eq ? "mini" : ""
...
WriteAttributeTo(__razor_template_writer, "class", Tuple.Create(" class=\"", 5816), Tuple.Create("\"", 5892)
, Tuple.Create(Tuple.Create("", 5824), Tuple.Create("glyphicon", 5824), true)
, Tuple.Create(Tuple.Create(" ", 5833), Tuple.Create("glyphicon-fast-forward", 5834), true)
, Tuple.Create(Tuple.Create(" ", 5856), Tuple.Create("colorIcon", 5857), true)
, Tuple.Create(Tuple.Create(" ", 5866), Tuple.Create("green", 5867), true)
            
            #line 152 "..\..\DiffLog\Views\OperationLog.cshtml"
, Tuple.Create(Tuple.Create(" ", 5872), Tuple.Create<System.Object, System.Int32>(eq ? "mini" : ""
