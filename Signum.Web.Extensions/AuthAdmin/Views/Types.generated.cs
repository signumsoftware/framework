...
namespace ASP
{
    ...
    public partial class _AuthAdmin_Views_Types_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _AuthAdmin_Views_Types_cshtml()
        {
        }
...
WriteLiteral("                            ");
            ...
            #line 99 "..\..\AuthAdmin\Views\Types.cshtml"
                       Write(Html.CheckBox(fallback.Compose("Create"), fallback.Value.HasValue && fallback.Value.Value.IsActive(TypeAllowedBasic.Create), new Dictionary<string, object> { { "data-tag", "Create" } }));
...
WriteLiteral("                            ");
            ...
            #line 104 "..\..\AuthAdmin\Views\Types.cshtml"
                       Write(Html.CheckBox(fallback.Compose("Modify"), fallback.Value.HasValue && fallback.Value.Value.IsActive(TypeAllowedBasic.Modify), new Dictionary<string, object> { { "data-tag", "Modify" } }));
...
WriteLiteral("                            ");
            ...
            #line 109 "..\..\AuthAdmin\Views\Types.cshtml"
                       Write(Html.CheckBox(fallback.Compose("Read"), fallback.Value.HasValue && fallback.Value.Value.IsActive(TypeAllowedBasic.Read), new Dictionary<string, object> { { "data-tag", "Read" } }));
...
WriteLiteral("                            ");
            ...
            #line 114 "..\..\AuthAdmin\Views\Types.cshtml"
                       Write(Html.CheckBox(fallback.Compose("None"), fallback.Value.HasValue && fallback.Value.Value.IsActive(TypeAllowedBasic.None), new Dictionary<string, object> { { "data-tag", "None" } }));
...
WriteAttribute("href", Tuple.Create(" href=\"", 7069), Tuple.Create("\"", 7173)
            
            #line 127 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create("", 7076), Tuple.Create<System.Object, System.Int32>(Url.Action((AuthAdminController a) => a.Properties(tc.Value.Role, item.Value.Resource.ToLite()))
...
WriteAttribute("class", Tuple.Create(" class=\"", 7218), Tuple.Create("\"", 7291)
, Tuple.Create(Tuple.Create("", 7226), Tuple.Create("sf-auth-thumb", 7226), true)
, Tuple.Create(Tuple.Create(" ", 7239), Tuple.Create("sf-auth-", 7240), true)
            
            #line 128 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create("", 7248), Tuple.Create<System.Object, System.Int32>(item.Value.Properties.ToString().ToLower()
...
WriteAttribute("href", Tuple.Create(" href=\"", 7737), Tuple.Create("\"", 7841)
            
            #line 139 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create("", 7744), Tuple.Create<System.Object, System.Int32>(Url.Action((AuthAdminController a) => a.Operations(tc.Value.Role, item.Value.Resource.ToLite()))
...
WriteAttribute("class", Tuple.Create(" class=\"", 7886), Tuple.Create("\"", 7959)
, Tuple.Create(Tuple.Create("", 7894), Tuple.Create("sf-auth-thumb", 7894), true)
, Tuple.Create(Tuple.Create(" ", 7907), Tuple.Create("sf-auth-", 7908), true)
            
            #line 140 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create("", 7916), Tuple.Create<System.Object, System.Int32>(item.Value.Operations.ToString().ToLower()
...
WriteAttribute("href", Tuple.Create(" href=\"", 8394), Tuple.Create("\"", 8495)
            
            #line 151 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create("", 8401), Tuple.Create<System.Object, System.Int32>(Url.Action((AuthAdminController a) => a.Queries(tc.Value.Role, item.Value.Resource.ToLite()))
...
WriteAttribute("class", Tuple.Create(" class=\"", 8540), Tuple.Create("\"", 8610)
, Tuple.Create(Tuple.Create("", 8548), Tuple.Create("sf-auth-thumb", 8548), true)
, Tuple.Create(Tuple.Create(" ", 8561), Tuple.Create("sf-auth-", 8562), true)
            
            #line 152 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create("", 8570), Tuple.Create<System.Object, System.Int32>(item.Value.Queries.ToString().ToLower()
...
WriteAttribute("class", Tuple.Create(" class=\"", 9486), Tuple.Create("\"", 9556)
, Tuple.Create(Tuple.Create("", 9494), Tuple.Create("sf-auth-tree", 9494), true)
            
            #line 168 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create(" ", 9506), Tuple.Create<System.Object, System.Int32>(iter.IsLast ? "sf-auth-blank" : "sf-auth-line"
...
WriteAttribute("class", Tuple.Create(" class=\"", 9612), Tuple.Create("\"", 9683)
, Tuple.Create(Tuple.Create("", 9620), Tuple.Create("sf-auth-tree", 9620), true)
            
            #line 170 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create(" ", 9632), Tuple.Create<System.Object, System.Int32>(iter2.IsLast ? "sf-auth-blank" : "sf-auth-line"
...
WriteAttribute("class", Tuple.Create(" class=\"", 9739), Tuple.Create("\"", 9822)
, Tuple.Create(Tuple.Create("", 9747), Tuple.Create("sf-auth-tree", 9747), true)
            
            #line 172 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create(" ", 9759), Tuple.Create<System.Object, System.Int32>(conditionIter.IsLast ? "sf-auth-leaf-last" : "sf-auth-leaf"
...
WriteAttribute("title", Tuple.Create(" title=\"", 9934), Tuple.Create("\"", 9997)
            
            #line 174 "..\..\AuthAdmin\Views\Types.cshtml"
         , Tuple.Create(Tuple.Create("", 9942), Tuple.Create<System.Object, System.Int32>(AuthMessage.AuthAdmin_RemoveCondition.NiceToString()
...
WriteAttribute("colspan", Tuple.Create(" colspan=\"", 11760), Tuple.Create("\"", 11850)
            
            #line 203 "..\..\AuthAdmin\Views\Types.cshtml"
, Tuple.Create(Tuple.Create("", 11770), Tuple.Create<System.Object, System.Int32>(1 + (propertyRules ? 1 : 0) + (operationRules ? 1 : 0) + (queryRules ? 1 : 0)
