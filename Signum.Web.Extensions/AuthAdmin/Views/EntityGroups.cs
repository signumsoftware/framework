...
WriteLiteral("\r\n                </th>\r\n                <th>\r\n                    ");
               ...
               Write(Html.PropertyNiceName((RuleEntityGroupDN r)=>r.Priority));
...
"          ");
               ...
               Write(Html.Span(null, item.Value.Resource == null ? "[Fallback]" : item.Value.Resource.NiceToString()));

WriteLiteral("\r\n                    ");


               Write(Html.Hidden(item.Compose("Resource"), item.Value.Resource == null ? "[FALLBACK]" : EnumDN.UniqueKey(item.Value.Resource)));

WriteLiteral("\r\n                </td>\r\n                <td>\r\n                    <a class=\"cbLi" +
"nk create\">\r\n                        ");


                   Write(Html.CheckBox(item.Compose("Create"), item.Value.Allowed.IsActive(TypeAllowedBasic.Create), new { tag = "Create" }));

WriteLiteral("\r\n                    </a>\r\n                </td>\r\n                <td>\r\n        " +
"            <a class=\"cbLink modify\">\r\n                        ");


                   Write(Html.CheckBox(item.Compose("Modify"), item.Value.Allowed.IsActive(TypeAllowedBasic.Modify), new { tag = "Modify" }));

WriteLiteral("\r\n                    </a>\r\n                </td>\r\n                <td>\r\n        " +
"            <a class=\"cbLink read\">\r\n                        ");


                   Write(Html.CheckBox(item.Compose("Read"), item.Value.Allowed.IsActive(TypeAllowedBasic.Read), new { tag = "Read" }));

WriteLiteral("\r\n                    </a>\r\n                </td>\r\n                <td>\r\n        " +
"            <a class=\"cbLink none\">\r\n                        ");


                   Write(Html.CheckBox(item.Compose("None"), item.Value.Allowed.IsActive(TypeAllowedBasic.None), new { tag = "None" }));

WriteLiteral("\r\n                    </a>\r\n                </td>\r\n                <td>\r\n        " +
"            ");


               Write(Html.TextBox(item.Compose("Priority"), item.Value.Priority));
