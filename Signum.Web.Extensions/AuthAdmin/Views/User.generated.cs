...
namespace Signum.Web.Extensions.AuthAdmin.Views
{
    ...
    public class User : System.Web.Mvc.WebViewPage<dynamic>
    {
        public User()
        {
        }
...
Write(Html.ValueLine(e, f => f.UserName, vl => vl.ValueHtmlProps["size"] = 50));
   ...
   Write(Html.Field(Resources.ChangePasswordAspx_NewPassword,
   ...
   Write(Html.Field(Resources.ChangePasswordAspx_ConfirmNewPassword, 
