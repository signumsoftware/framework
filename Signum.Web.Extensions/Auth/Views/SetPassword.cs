...
namespace ASP
{
    ...
    public class _Page_Auth_Views_SetPassword_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {


        public _Page_Auth_Views_SetPassword_cshtml()
        {
        }
...
Write(Html.Field(Resources.NewPassword,  
    Html.TextBox(e.Compose(UserMapping.NewPasswordKey), "", new {type="password"})));

                                                                                   
    
Write(Html.Field(Resources.ConfirmNewPassword,  
