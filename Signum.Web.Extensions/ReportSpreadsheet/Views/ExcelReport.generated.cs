 ...
 using (var e = Html.TypeContext<ExcelReportDN>())
{
   ...
   Write(Html.ValueLine(query, f => f.Name, f => { f.ReadOnly = true; f.LabelText = "Query"; }));
            ...
            #line 13 "..\..\ReportSpreadsheet\Views\ExcelReport.cshtml"
   Write(Html.Hidden(query.Compose("Key"), query.Value.Key));
            ...
            #line 14 "..\..\ReportSpreadsheet\Views\ExcelReport.cshtml"
   Write(Html.Hidden(query.Compose("DisplayName"), query.Value.Name));
            ...
            #line 17 "..\..\ReportSpreadsheet\Views\ExcelReport.cshtml"
Write(Html.ValueLine(e, f => f.DisplayName));
    ...
    //@Html.FileLine(e, f => f.File, fl => fl.AsyncUpload = false)
            ...
            #line 19 "..\..\ReportSpreadsheet\Views\ExcelReport.cshtml"
