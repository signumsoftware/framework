...
(function (SF) {
    (function (TabsRepeater) {
        ...
        TabsRepeater.addItem = addItem;
        ;

        once("SF.TabRepeater", function () {
    ...
    })(SF.TabsRepeater || (SF.TabsRepeater = {}));
    var TabsRepeater = SF.TabsRepeater;
})(SF || (SF = {}));
//# sourceMappingURL=SF_TabsRepeater.js.map
