...
Write(Html.CountSearchControl(sc, new FindOptions(typeof(EmailMessageDN))
    {
...
Write(Html.CountSearchControl(sc, new FindOptions(typeof(ExceptionDN))
    {
        FilterOptions = { new FilterOption("Entity.Pop3Reception", sc.Value) }
    }, csc => { csc.PopupViewPrefix = sc.Compose("ex"); }));
