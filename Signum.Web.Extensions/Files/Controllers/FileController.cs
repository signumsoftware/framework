    ...
    public class FileController : Controller
    {
        ...
        private ContentResult UploadResult(string prefix, IFile file, bool shouldHaveSaved)
        {
            ...
            if (file.BinaryFile == null /* If file has been saved */ || !shouldHaveSaved)
            {
                ...
                sb.AppendLine("parDoc.getElementById('{0}').innerHTML='{1}';".Formato(TypeContextUtilities.Compose(prefix, file is EmbeddedEntity ? EntityBaseKeys.ToStr : EntityBaseKeys.Link), file.FileName));
