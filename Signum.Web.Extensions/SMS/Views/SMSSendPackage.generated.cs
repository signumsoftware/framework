...
namespace Signum.Web.Extensions.SMS.Views
{
    ...
    public class SMSSendPackage : System.Web.Mvc.WebViewPage<dynamic>
    {
...
Write(Html.ValueLine(sc, s => s.NumLines));
            ...
            #line 6 "..\..\SMS\Views\SMSSendPackage.cshtml"
Write(Html.ValueLine(sc, s => s.NumErrors));
            ...
            #line 7 "..\..\SMS\Views\SMSSendPackage.cshtml"
Write(Html.SearchControl(new FindOptions(typeof(SMSMessageDN))
    {
        ...
        SearchOnLoad = true
            ...
            #line 11 "..\..\SMS\Views\SMSSendPackage.cshtml"
                               ;
}
