...
WriteLiteral("    <table class=\"sf-chart-builder\" data-url=\"");
...
WriteLiteral("\r\n                    ");
               ...
               Write(Html.Hidden(chart.Compose("ChartType"), chart.Value.ChartType.ToString(), new { @class = "sf-chart-type-value" }));
...
WriteLiteral("                        <div class=\"");
                               ...
                               Write(ChartClient.ChartTypeImgClass(chart.Value, type.ChartType));
...
"              </tr>\r\n");
                        ...
                        if (chart.Value.Dimension1 != null)
                        {
                           ...
                           Write(Html.HiddenRuntimeInfo(chart, cr => cr.Dimension1));

                                                                                   
                                
                           Write(Html.EmbeddedControl(chart, cr => cr.Dimension1, ec => ec.ViewData[ViewDataKeys.QueryName] = queryDescription.QueryName));
                        ...
                        if (chart.Value.Dimension2 != null)
                        {
                           ...
                           Write(Html.HiddenRuntimeInfo(chart, cr => cr.Dimension2));

                                                                                   
                                
                           Write(Html.EmbeddedControl(chart, cr => cr.Dimension2, ec => ec.ViewData[ViewDataKeys.QueryName] = queryDescription.QueryName));
                        ...
                        if (chart.Value.Value1 != null)
                        {
                           ...
                           Write(Html.HiddenRuntimeInfo(chart, cr => cr.Value1));

                                                                               
                                
                           Write(Html.EmbeddedControl(chart, cr => cr.Value1, ec => ec.ViewData[ViewDataKeys.QueryName] = queryDescription.QueryName));
                        ...
                        if (chart.Value.Value2 != null)
                        {
                           ...
                           Write(Html.HiddenRuntimeInfo(chart, cr => cr.Value2));

                                                                               
                                
                           Write(Html.EmbeddedControl(chart, cr => cr.Value2, ec => ec.ViewData[ViewDataKeys.QueryName] = queryDescription.QueryName));
