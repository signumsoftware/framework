...
WriteAttribute("class", Tuple.Create(" class=\"", 694), Tuple.Create("\"", 791)
, Tuple.Create(Tuple.Create("", 702), Tuple.Create("part-control-panel", 702), true)
, Tuple.Create(Tuple.Create(" ", 720), Tuple.Create("col-sm-", 721), true)
            
            #line 24 "..\..\Dashboard\Views\DashboardView.cshtml"
, Tuple.Create(Tuple.Create("", 728), Tuple.Create<System.Object, System.Int32>(part.Columns
...
, 728), false)
            ...
            #line 24 "..\..\Dashboard\Views\DashboardView.cshtml"
, Tuple.Create(Tuple.Create(" ", 741), Tuple.Create<System.Object, System.Int32>(offset == 0 ? null : "col-sm-offset-" + offset
