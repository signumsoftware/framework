...
namespace ASP
{
    ...
    public partial class _Dashboard_Views_CountSearchControlPart_cshtml : System.Web.Mvc.WebViewPage<dynamic>
    {
        public _Dashboard_Views_CountSearchControlPart_cshtml()
        {
        }
...
WriteLiteral(">\r\n");
         ...
         for (int i = 0; i < tc.Value.UserQueries.Count; i++)
        {
            ...
            object queryName = Finder.Manager.QuerySettings.Keys.FirstEx(k => QueryUtils.GetKey(k) == uq.UserQuery.Query.Key);
