...
export namespace SearchMessage {
  ...
  export const IsVeryPowerfullButCanBeIntimidatingTakeSomeTimeToLearnHowToUseItWillBeWorthIt: MessageKey = new MessageKey("SearchMessage", "IsVeryPowerfullButCanBeIntimidatingTakeSomeTimeToLearnHowToUseItWillBeWorthIt");
  export const TheBasics: MessageKey = new MessageKey("SearchMessage", "TheBasics");
  export const CurrentlyWeAreInTheQuery: MessageKey = new MessageKey("SearchMessage", "CurrentlyWeAreInTheQuery");
  export const YouCanOpenA: MessageKey = new MessageKey("SearchMessage", "YouCanOpenA");
  export const ByClickingThe: MessageKey = new MessageKey("SearchMessage", "ByClickingThe");
  export const IconOrDoing: MessageKey = new MessageKey("SearchMessage", "IconOrDoing");
  export const DoubleClick: MessageKey = new MessageKey("SearchMessage", "DoubleClick");
  export const InTheRowButNotInALink: MessageKey = new MessageKey("SearchMessage", "InTheRowButNotInALink");
  ...
  export const Doing: MessageKey = new MessageKey("SearchMessage", "Doing");
  export const InTheRowWillSelectTheEntityAndCloseTheModalAutomaticallyAlternativelyYouCanSelectOneEntityAndClickOK: MessageKey = new MessageKey("SearchMessage", "InTheRowWillSelectTheEntityAndCloseTheModalAutomaticallyAlternativelyYouCanSelectOneEntityAndClickOK");
  export const YouCanUseThePreparedFiltersOnTheTopToQuicklyFindThe: MessageKey = new MessageKey("SearchMessage", "YouCanUseThePreparedFiltersOnTheTopToQuicklyFindThe");
  export const YouAreLookingFor: MessageKey = new MessageKey("SearchMessage", "YouAreLookingFor");
  export const OrderingResults: MessageKey = new MessageKey("SearchMessage", "OrderingResults");
  export const YouCanOrderResultsByClickingInAColumnHeaderDefaultOrderingIs: MessageKey = new MessageKey("SearchMessage", "YouCanOrderResultsByClickingInAColumnHeaderDefaultOrderingIs");
  export const Ascending: MessageKey = new MessageKey("SearchMessage", "Ascending");
  export const AndByClickingAgainItChangesTo: MessageKey = new MessageKey("SearchMessage", "AndByClickingAgainItChangesTo");
  export const Descending: MessageKey = new MessageKey("SearchMessage", "Descending");
  export const YouCanOrderByMoreThanOneColumnIfYouKeep: MessageKey = new MessageKey("SearchMessage", "YouCanOrderByMoreThanOneColumnIfYouKeep");
  export const Shift: MessageKey = new MessageKey("SearchMessage", "Shift");
  export const DownWhenClickingOnTheColumnsHeader: MessageKey = new MessageKey("SearchMessage", "DownWhenClickingOnTheColumnsHeader");
  export const ChangeColumns: MessageKey = new MessageKey("SearchMessage", "ChangeColumns");
  export const YouAreNotLimitedToTheColumnsYouSeeTheDefaultColumnsCanBeChangedAtWillBy: MessageKey = new MessageKey("SearchMessage", "YouAreNotLimitedToTheColumnsYouSeeTheDefaultColumnsCanBeChangedAtWillBy");
  export const RightClicking: MessageKey = new MessageKey("SearchMessage", "RightClicking");
  export const InAColumnHeaderAndThenSelect: MessageKey = new MessageKey("SearchMessage", "InAColumnHeaderAndThenSelect");
  ...
  export const Or: MessageKey = new MessageKey("SearchMessage", "Or");
  export const RemoveColumn: MessageKey = new MessageKey("SearchMessage", "RemoveColumn");
  export const YouCanAlso: MessageKey = new MessageKey("SearchMessage", "YouCanAlso");
  export const Rearrange: MessageKey = new MessageKey("SearchMessage", "Rearrange");
  export const TheColumnsByDraggingAndDroppingThemToAnotherPosition: MessageKey = new MessageKey("SearchMessage", "TheColumnsByDraggingAndDroppingThemToAnotherPosition");
  export const WhenInsertingTheNewColumnWillBeAddedBeforeOrAfterTheSelectedColumnDependingWhereYou: MessageKey = new MessageKey("SearchMessage", "WhenInsertingTheNewColumnWillBeAddedBeforeOrAfterTheSelectedColumnDependingWhereYou");
  export const ClickOnThe: MessageKey = new MessageKey("SearchMessage", "ClickOnThe");
  export const ButtonToOpenTheAdvancedFiltersThisWillAllowYouCreateComplexFiltersManuallyBySelectingThe: MessageKey = new MessageKey("SearchMessage", "ButtonToOpenTheAdvancedFiltersThisWillAllowYouCreateComplexFiltersManuallyBySelectingThe");
  export const OfTheEntityOrARelatedEntitiesAComparison: MessageKey = new MessageKey("SearchMessage", "OfTheEntityOrARelatedEntitiesAComparison");
  export const AndA: MessageKey = new MessageKey("SearchMessage", "AndA");
  export const ToCompare: MessageKey = new MessageKey("SearchMessage", "ToCompare");
  export const TrickYouCan: MessageKey = new MessageKey("SearchMessage", "TrickYouCan");
  export const ColumnHeader: MessageKey = new MessageKey("SearchMessage", "ColumnHeader");
  export const AndChoose: MessageKey = new MessageKey("SearchMessage", "AndChoose");
  export const ToQuicklyFilterByThisColumnEvenMoreYouCan: MessageKey = new MessageKey("SearchMessage", "ToQuicklyFilterByThisColumnEvenMoreYouCan");
  export const ToFilterByThisValueDirectly: MessageKey = new MessageKey("SearchMessage", "ToFilterByThisValueDirectly");
  export const GroupingResultsByOneOrMoreColumn: MessageKey = new MessageKey("SearchMessage", "GroupingResultsByOneOrMoreColumn");
  export const YouCanGroupResultsBy: MessageKey = new MessageKey("SearchMessage", "YouCanGroupResultsBy");
  export const InAColumnHeaderAndSelecting: MessageKey = new MessageKey("SearchMessage", "InAColumnHeaderAndSelecting");
  export const GroupByThisColumn: MessageKey = new MessageKey("SearchMessage", "GroupByThisColumn");
  export const AllTheColumnsWillDisappearExceptTheSelectedOneAndAnAggregationColumnTypically: MessageKey = new MessageKey("SearchMessage", "AllTheColumnsWillDisappearExceptTheSelectedOneAndAnAggregationColumnTypically");
  export const GroupHelp: MessageKey = new MessageKey("SearchMessage", "GroupHelp");
  export const AnyNewColumnShouldEitherBeAnAggregate: MessageKey = new MessageKey("SearchMessage", "AnyNewColumnShouldEitherBeAnAggregate");
  export const OrItWillBeConsideredANewGroupKey: MessageKey = new MessageKey("SearchMessage", "OrItWillBeConsideredANewGroupKey");
  export const OnceGroupingYouCanFilterNormallyOrUsingAggregatesAsTheField: MessageKey = new MessageKey("SearchMessage", "OnceGroupingYouCanFilterNormallyOrUsingAggregatesAsTheField");
  export const InSql: MessageKey = new MessageKey("SearchMessage", "InSql");
  export const FinallyYouCanStopGroupingBy: MessageKey = new MessageKey("SearchMessage", "FinallyYouCanStopGroupingBy");
  export const InAColumnHeaderAndSelect: MessageKey = new MessageKey("SearchMessage", "InAColumnHeaderAndSelect");
