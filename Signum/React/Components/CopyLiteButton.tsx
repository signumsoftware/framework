...
export default function CopyLiteButton(p: CopyLiteButtonProps): React.ReactElement | null {
  ...
  return (
    <span className={p.className}>
      <a ref={link} className="btn btn-sm btn-outline-secondary sf-pointer mx-1" onClick={handleCopyLiteButton} title={NormalControlMessage.CopyEntityTypeAndIdForAutocomplete.niceToString()} >
