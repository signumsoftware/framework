...
public static class ExecutionMode
{
    ...
    public static event Func<Lite<Entity>, string, IDisposable?>? OnApiRetrieved;
    public static IDisposable? ApiRetrievedScope(Lite<Entity> entity, string viewAction)
    {
