...
namespace Signum.React.Selenium
{
    public class ChartPageProxy : IDisposable
    {
        ...
        public IWebElement DrawButtonElement
        {
        ...
        public IWebElement DataTabElement
        {
        ...
        public IWebElement ChartTabElement
        {
        ...
        public IWebElement ChartContianerElement
        {
            get { return By.CssSelector("#sf-chart-container"); }
        }

        public IWebElement MenuOptionElement(string menuId, string optionId)
        {
            return By.CssSelector("a#{0}".FormatWith(optionId));
        }

        public IWebElement MenuOptionElementByAttr(string menuId, string optionLocator)
        {
