...
public class UserQueryEntity : Entity, IUserAssetEntity, IHasEntityType
{
    ...
    internal void ParseData(QueryDescription description)
    {
        ...
        foreach (var c in Columns)
            c.ParseData(this, description, SubTokensOptions.CanElement | SubTokensOptions.CanToArray | (canAggregate != 0 ? canAggregate : SubTokensOptions.CanOperation | SubTokensOptions.CanManual));
