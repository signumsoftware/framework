    ...
    public class PunchcardChartScript : ChartScript                
    {
        public PunchcardChartScript()
        {
            ...
            this.Parameters = new List<ChartScriptParameter>
            {
                ...
                new ChartScriptParameter("FillColor", ChartParameterType.String) {  ValueDefinition = null },
                ...
                new ChartScriptParameter("InnerFillColor", ChartParameterType.String) {  ValueDefinition = null },
                ...
                new ChartScriptParameter("HorizontalLineColor", ChartParameterType.String) {  ValueDefinition = null },
                new ChartScriptParameter("VerticalLineColor", ChartParameterType.String) {  ValueDefinition = null }
            };
        }      
    }                
}
