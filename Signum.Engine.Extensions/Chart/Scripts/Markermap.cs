        ...
        public MarkermapChartScript(): base(GoogleMapsCharScript.Markermap)
        {
            ...
            this.ParameterGroups = new List<ChartScriptParameterGroup>
            {
                ...
                new ChartScriptParameterGroup()
                {
                    ...
                    new ChartScriptParameter("Colorch", ChartParameterType.Enum) {  ColumnIndex = 7, ValueDefinition = EnumValueList.Parse("category10|category20|category20b|category20c|accent|paired|pastel1|pastel2|set1|set2|set3") }
                }
            };
        }      
    }                
