...
namespace Signum.Utilities.ExpressionTrees
{
    ...
    public static class QueryableAsyncExtensions
    {
        ...
        public static Task<TSource> SingleOrDefaultAsync<TSource>(this IQueryable<TSource> source) => BindAsyncWithoutCancellationToken___(() => source.SingleOrDefault());
        public static Task<TSource> SingleOrDefaultAsync<TSource>(this IQueryable<TSource> source, CancellationToken token) => Bind(token, () => source.SingleOrDefault());
        public static Task<TSource> SingleOrDefaultAsync<TSource>(this IQueryable<TSource> source, Expression<Func<TSource, bool>> predicate) => BindAsyncWithoutCancellationToken___(() => source.SingleOrDefault(predicate));
        public static Task<TSource> SingleOrDefaultAsync<TSource>(this IQueryable<TSource> source, Expression<Func<TSource, bool>> predicate, CancellationToken token) => Bind(token, () => source.SingleOrDefault(predicate));
