...
import { PredictSimpleClassificationEntity } from '../Signum.Entities.MachineLearning'
...
export default class PredictSimpleClassification extends React.Component<{ ctx: TypeContext<PredictSimpleClassificationEntity> }> {
