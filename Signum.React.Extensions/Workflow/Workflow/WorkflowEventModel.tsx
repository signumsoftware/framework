  ...
  return (
    <div>
      ...
      <EntityLine ctx={ctx.subCtx(te => te.condition)}
        findOptions={{ queryName: WorkflowTimerConditionEntity, parentToken: WorkflowTimerConditionEntity.token().entity(a => a.mainEntityType), parentValue: p.mainEntityType }} />
    </div>
  );
}
