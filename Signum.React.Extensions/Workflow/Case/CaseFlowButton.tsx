...
export default class CaseFlowButton extends React.Component < CaseFlowButtonProps, void>{
    ...
    render() {
        return (
            <button className="btn btn-default pull-right flip" href="" onClick={this.handleClick}>
