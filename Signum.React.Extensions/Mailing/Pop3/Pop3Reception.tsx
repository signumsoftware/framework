...
export default class Pop3Reception extends React.Component<{ ctx: TypeContext<Pop3ReceptionEntity> }, void> {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <CountSearchControlLine ctx={sc} findOptions={{ queryName: EmailMessageEntity, parentColumn: "Entity.ReceptionInfo.Reception", parentValue: sc.value }} />
                <CountSearchControlLine ctx={sc} findOptions={{ queryName: ExceptionEntity, parentColumn: "Entity.Pop3Reception", parentValue: sc.value }} />}
            </div>
        );
    }
}
