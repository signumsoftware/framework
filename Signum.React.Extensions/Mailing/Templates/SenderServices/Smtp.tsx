...
import { EmailSenderConfigurationEntity, SmtpNetworkDeliveryEmbedded, ClientCertificationFileEmbedded, SmtpEntity, ExchangeWebServiceEntity, MicrosoftGraphEntity } from '../../Signum.Entities.Mailing'
import { Binding } from '@framework/Reflection'
import { DoublePassword } from '../../../Authorization/Templates/DoublePassword'

export default function Smtp(p: { ctx: TypeContext<SmtpEntity> }) {
  const sc = p.ctx;
