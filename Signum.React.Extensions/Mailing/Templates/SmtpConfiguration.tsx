...
export default function SmtpConfiguration(p : { ctx: TypeContext<SmtpConfigurationEntity> }){
  const sc = p.ctx;
  ...
  return (
    <div>
      ...
      <EntityDetail ctx={sc.subCtx(s => s.network)} getComponent={(sc: TypeContext<SmtpNetworkDeliveryEmbedded>) => {
        return (
          <div>
            ...
            <EntityRepeater ctx={sc.subCtx(s => s.clientCertificationFiles)} getComponent={(sc: TypeContext<ClientCertificationFileEmbedded>) => {
              return (
                <div>
