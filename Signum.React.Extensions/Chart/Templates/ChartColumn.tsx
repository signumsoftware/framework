            ...
            <div className="row">
              ...
              {getColorPalettes().map((t, i) =>
                <div className="col-sm-4" key={i}>
                  {t && <ChartPaletteLink ctx={ctxBasic} type={t} currentPalettes={p.colorPalettes} />}
                </div>)
              }
            </div>
          </div>
...
export const ChartPaletteLink = (props: ChartPaletteLinkProps) =>
  <FormGroup ctx={props.ctx}
    ...
    <a href="#" className={props.ctx.formControlPlainTextClass} onClick={e => { e.preventDefault(); ChartPaletteClient.navigatePalette(props.type); }}>
