  ...
  return (
    <svg direction="ltr" width={width} height={height} >
      {nodes.map((d, i) => {
        ...
        return (<g key={getNodeKey(d)} className="node sf-transition shadow-group" transform={translate(d.x0 - p2, d.y0 - p2) + scaleTransform}>
          {isFolder(d.data) &&
          ...
          {!isFolder(d.data) &&
            <rect className="leaf sf-transition shadow"
