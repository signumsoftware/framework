...
export function start(options: { routes: JSX.Element[] }) {
    Navigator.addSettings(new EntitySettings(TimeSpanEmbedded, e => new ViewPromise(resolve => require(['./Templates/TimeSpan'], resolve))));
    Navigator.addSettings(new EntitySettings(DateSpanEmbedded, e => new ViewPromise(resolve => require(['./Templates/DateSpan'], resolve))));
