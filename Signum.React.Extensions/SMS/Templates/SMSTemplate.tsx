...
export function SMSTemplateMessageComponent(p: SMSTemplateMessageComponentProps) {
  ...
  var remaining = useAPI(undefined, abort => SMSClient.API.getRemainingCharacters(throttleText, p.removeNoSMSCharacters), [throttleText, p.removeNoSMSCharacters], { avoidReset: true });
