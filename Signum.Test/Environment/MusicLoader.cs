...
namespace Signum.Test.Environment
{
    public static class MusicLoader
    {
        ...
        public static void Load()
        {
            ...
            new NoteWithDateEntity { CreationTime = DateTime.Now.AddHours(+8), CreationDate = Date.Today, Text = "American alternative rock band", Target = smashingPumpkins }
            ...
            new NoteWithDateEntity { CreationTime = DateTime.Now.AddDays(-100).AddHours(-8), CreationDate = Date.Today.AddDays(-100), Text = "The blue one with the angel", Target = mellon }
                .Execute(NoteWithDateOperation.Save);
