import { MessageKey, QueryKey, Type, EnumType } from '../../Signum/React/Reflection';
...
export declare const AzureADType: EnumType<AzureADType>;
export type AzureADType = "AzureAD" | "B2C" | "ExternalID";
