    ...
    public static void Start(SchemaBuilder sb)
    {
        ...
        new Graph<DynamicSqlMigrationEntity>.Construct(DynamicSqlMigrationOperation.Create)
        {
            Construct = args =>
            {
                ...
                var script = Schema.Current.SynchronizationScript(out var rep, interactive: false, replaceDatabaseName: SqlMigrationRunner.DatabaseNameReplacement, autoReplacement: autoReplacement);
