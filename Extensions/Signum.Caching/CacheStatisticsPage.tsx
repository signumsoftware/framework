  ...
  return (
    <div>
      ...
      <div className="btn-toolbar">
        {state.isEnabled == true && <button onClick={handleDisabled} className="sf-button btn btn-light" style={{ color: "var(--bs-danger)" }}>Disable</button>}
        {state.isEnabled == false && <button onClick={handleEnabled} className="sf-button btn btn-light" style={{ color: "var(--bs-success)" }}>Enabled</button>}
        {<button onClick={handleClear} className="sf-button btn btn-light" style={{ color: "var(--bs-primary)" }}>Clear</button>}
      </div >
      <div className="m-2">
