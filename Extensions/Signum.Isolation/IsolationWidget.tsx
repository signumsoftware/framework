...
export function IsolationWidget(p: IsolationWidgetProps): React.JSX.Element | null {
  ...
  return (
    <strong className="badge btn-outline-secondary" style={{ display: "flex" }}>{isolation == null ? IsolationMessage.GlobalEntity.niceToString() : getToString(isolation)}</strong>
  );
}
