...
OperationManager.prototype = {
    ...
    entityIsValid: function() {
        ...
        var info = this.entityInfo();
        var validator = new PartialValidator({ prefix: this.options.prefix, type: info.runtimeType(), id: info.id() }).validate();
...
controllerUrl: "Operation/OperationExecute"
    ...
    NotifyInfo(lang['executingOperation']);
        ...
        $.ajax({
            ...
            data: this.requestData((isFalse(this.options.multiStep)) ? this.options.prefix : this.newPrefix()),
            async: false,
            dataType: "html",
            success: function(operationResult) {
                ...
                if (empty(self.options.prefix)) //NormalWindow
                    ...
                    $(self.pf("externalPopupDiv")).html(operationResult);
