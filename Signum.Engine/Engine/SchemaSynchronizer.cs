                ...
                (tn, tab, dif) =>
                    ...
                    Synchronizer.SynchronizeScript(
                        ...
                        (cn, tabCol) => SqlPreCommandSimple.Combine(Spacing.Simple,
                            tabCol.PrimaryKey && dif.PrimaryKeyName != null ? SqlBuilder.AlterTableDropConstraint(tab.Name, dif.PrimaryKeyName) : null,                        
                        ...
                        (cn, tabCol, difCol) => SqlPreCommand.Combine(Spacing.Simple,
                            ...
                            difCol.ColumnEquals(tabCol, ignorePrimaryKey: true) ? null : SqlPreCommand.Combine(Spacing.Simple, 
                                tabCol.PrimaryKey && !difCol.PrimaryKey && dif.PrimaryKeyName != null ? SqlBuilder.AlterTableDropConstraint(tab.Name, dif.PrimaryKeyName) : null,
