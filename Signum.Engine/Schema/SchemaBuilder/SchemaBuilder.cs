...
namespace Signum.Engine.Maps
{
    public class SchemaBuilder
    {
        ...
        protected virtual Field GenerateFieldImplmentedBy(PropertyRoute route, NameSequence name, bool forceNull, Type[] types)
        {
            ...
            bool nullable = Settings.IsNullable(route, forceNull) || types.Length > 1;
