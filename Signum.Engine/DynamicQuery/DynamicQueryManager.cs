    ...
    public class ExtensionInfo
    {
        public ExtensionInfo(Type type, string key, LambdaExpression lambda, Type entityType)
        {
            ...
            if (cm != null)
            {
                ...
                this.Implementations = cleanType.IsIIdentifiable() ? (Implementations?)ColumnDescriptionFactory.AggregateImplementations(cm.PropertyRoutes.Select(pr => pr.GetImplementations()), cleanType) : null;
            }
