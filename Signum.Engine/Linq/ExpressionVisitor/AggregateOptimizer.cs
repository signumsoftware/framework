...
//        static SourceExpression VisitFrom(SourceExpression expression, Dictionary<ProjectionExpression, ColumnExpression> requests)
//        {
//            return new Switch<SourceExpression, SourceExpression>(expression)
...
//            HashSet<ProjectionExpression> myReq = new HashSet<ProjectionExpression>();
...
//            SourceExpression newFrom = VisitFrom(select.From, requestForOthers);
...
//            {
//                return new SelectExpression(select.Alias, false, null, newNewColums, newFrom, newWhere, newOrderBys, newGroupBys);
//            }
//            return select;
//        }
...
//            SourceExpression newLeft = VisitFrom(join.Left, leftRequests);
//            SourceExpression newRight = VisitFrom(join.Right, rightRequests);
...
//            {
//                return new JoinExpression(join.Type, join.JoinType, newLeft, newRight, newCondition); 
//            }
//            return join;
//        }
