...
<TestClass()> Public Class Entorno
...
#End Region
    ...
    <TestMethod()> Public Sub CrearElEntorno()
        ...
        Dim gbd As New FN.Trabajos.AD.TrabajosGBD(mRecurso)
    ...
    Private Sub ObtenerRecurso()
        ...
        Framework.AccesoDatos.MotorAD.LN.GestorInstanciacionLN.GestorMapPersistenciaCampos = New GestorMapPersistenciaCamposTrabajosTest()

    End Sub

End Class

Public Class GestorMapPersistenciaCamposTrabajosTest
