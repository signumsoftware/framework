...
Module Module1
    ...
    Public Sub Main()
        ...
        tablanavegacion.Add("Autorizacion", New MotorIU.Motor.Destino(GetType(FNMarcoIUWin.frmAutorizacion), GetType(FNMarcoIUWin.frmAutorizacionCtrl))) ' "ClienteAdmin.frmAutorizacion", "ClienteAdmin.frmAutorizacionctrl"))
        tablanavegacion.Add("Main", New MotorIU.Motor.Destino(GetType(FNMarcoIUWin.frmMain), Nothing)) ' "ClienteAdmin.frmMain", "ClienteAdmin.ControladorGenerico"))
        ...
        tablanavegacion.Add("Acercade", New MotorIU.Motor.Destino(GetType(FNMarcoIUWin.frmAcercaDe), Nothing)) ' "ClienteAdmin.frmAcercaDe", "ClienteAdmin.ControladorGenerico"))
        ...
        tablanavegacion.Add("FG", New MotorIU.Motor.Destino(GetType(MV2Controles.frmFormularioGenerico), Nothing)) ' "MV2Controles.frmFormularioGenerico", Nothing))
