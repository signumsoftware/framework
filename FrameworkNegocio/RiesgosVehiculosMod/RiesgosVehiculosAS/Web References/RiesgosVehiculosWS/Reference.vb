...
Namespace RiesgosVehiculosWS
    ...
    Partial Public Class RiesgosVehiculosWS
        ...
        Private CalcularNivelBonificacionOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event CalcularNivelBonificacionCompleted As CalcularNivelBonificacionCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/CalcularNivelBonificacion", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function CalcularNivelBonificacion(ByVal valorBonificacion As Double, <System.Xml.Serialization.XmlElementAttribute(DataType:="base64Binary")> ByVal categoria() As Byte, <System.Xml.Serialization.XmlElementAttribute(DataType:="base64Binary")> ByVal bonificacion() As Byte, ByVal fecha As Date) As String
            Dim results() As Object = Me.Invoke("CalcularNivelBonificacion", New Object() {valorBonificacion, categoria, bonificacion, fecha})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub CalcularNivelBonificacionAsync(ByVal valorBonificacion As Double, ByVal categoria() As Byte, ByVal bonificacion() As Byte, ByVal fecha As Date)
            Me.CalcularNivelBonificacionAsync(valorBonificacion, categoria, bonificacion, fecha, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub CalcularNivelBonificacionAsync(ByVal valorBonificacion As Double, ByVal categoria() As Byte, ByVal bonificacion() As Byte, ByVal fecha As Date, ByVal userState As Object)
            If (Me.CalcularNivelBonificacionOperationCompleted Is Nothing) Then
                Me.CalcularNivelBonificacionOperationCompleted = AddressOf Me.OnCalcularNivelBonificacionOperationCompleted
            End If
            Me.InvokeAsync("CalcularNivelBonificacion", New Object() {valorBonificacion, categoria, bonificacion, fecha}, Me.CalcularNivelBonificacionOperationCompleted, userState)
        End Sub
        
        Private Sub OnCalcularNivelBonificacionOperationCompleted(ByVal arg As Object)
            If (Not (Me.CalcularNivelBonificacionCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent CalcularNivelBonificacionCompleted(Me, New CalcularNivelBonificacionCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1366")>  _
    Public Delegate Sub CalcularNivelBonificacionCompletedEventHandler(ByVal sender As Object, ByVal e As CalcularNivelBonificacionCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.1366"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class CalcularNivelBonificacionCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
