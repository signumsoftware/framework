...
<Serializable()> _
Public Class ValorSexoCaracteristicaDN
    Inherits Framework.DatosNegocio.EntidadDN
    Implements Framework.Cuestionario.CuestionarioDN.IValorCaracteristicaDN

    Protected mSexo As FN.Personas.DN.TipoSexo
    ...
    Public Property ValorSexo() As FN.Personas.DN.TipoSexo
        Get
            Return Me.mSexo
        End Get
        Set(ByVal value As FN.Personas.DN.TipoSexo)
            Me.CambiarValorRef(Of FN.Personas.DN.TipoSexo)(value, Me.mSexo)
        End Set
    End Property
    ...
    Public Function ClonarIValorCaracteristica() As Framework.Cuestionario.CuestionarioDN.IValorCaracteristicaDN Implements Framework.Cuestionario.CuestionarioDN.IValorCaracteristicaDN.ClonarIValorCaracteristica
        Dim valorClon As ValorSexoCaracteristicaDN
