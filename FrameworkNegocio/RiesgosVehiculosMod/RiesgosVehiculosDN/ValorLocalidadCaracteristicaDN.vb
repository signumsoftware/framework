...
<Serializable()> _
Public Class ValorLocalidadCaracteristicaDN
    Inherits Framework.DatosNegocio.EntidadDN
    Implements Framework.Cuestionario.CuestionarioDN.IValorCaracteristicaDN

    Protected mLocalidad As FN.Localizaciones.DN.LocalidadDN
    ...
    Public Property ValorLocalidad() As FN.Localizaciones.DN.LocalidadDN
        Get
            Return Me.mLocalidad
        End Get
        Set(ByVal value As FN.Localizaciones.DN.LocalidadDN)
            Me.CambiarValorRef(Of FN.Localizaciones.DN.LocalidadDN)(value, Me.mLocalidad)
        End Set
    End Property

    Public Property Valor() As Object Implements IValorCaracteristicaDN.Valor
        Get
            Return Me.ValorLocalidad
        End Get
        Set(ByVal value As Object)
            Me.ValorLocalidad = value
        End Set
    End Property
    ...
    Public Function ClonarIValorCaracteristica() As Framework.Cuestionario.CuestionarioDN.IValorCaracteristicaDN Implements Framework.Cuestionario.CuestionarioDN.IValorCaracteristicaDN.ClonarIValorCaracteristica
        Dim valorClon As ValorLocalidadCaracteristicaDN
