...
<Serializable()> _
Public Class ValorModeloCaracteristicaDN
    ...
    Public Property ValorModelo() As ModeloDN
        Get
            Return Me.mModelo
        End Get
        Set(ByVal value As ModeloDN)
            Me.CambiarValorRef(Of ModeloDN)(value, Me.mModelo)
        End Set
    End Property

    Public Property Valor() As Object Implements IValorCaracteristicaDN.Valor
        Get
            Return Me.ValorModelo
        End Get
        Set(ByVal value As Object)
            Me.ValorModelo = value
        End Set
    End Property
    ...
    Public Function ClonarIValorCaracteristica() As Framework.Cuestionario.CuestionarioDN.IValorCaracteristicaDN Implements Framework.Cuestionario.CuestionarioDN.IValorCaracteristicaDN.ClonarIValorCaracteristica
        Dim valorClon As ValorModeloCaracteristicaDN
