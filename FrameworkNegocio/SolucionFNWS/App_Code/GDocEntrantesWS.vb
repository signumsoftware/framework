...
Public Class GDocEntrantesWS
    ...
    '    Dim recurso As RecursoLN
    '    Dim principal As UsuariosDN.PrincipalDN = Nothing
    ...
    <WebMethod(False)> _
     Public Function RecuperarArbolTiposEntNegocio() As Byte()
        ...
        '     principal = CType(WSHelper.ControladorSesionLN.ComprobarUsuario(Me), UsuariosDN.PrincipalDN)  ' verificacion de sesion
