...
Public Class DatosBasicosWS
    ...
    <WebMethod(True)> _
    Public Function BajaGenericoDN(ByVal pObjeto As Byte()) As Byte()
        ...
        miIEntidadDN = Framework.Utilidades.Serializador.DesSerializar(pObjeto)
        ...
        fs.BajaGenericoDN(Me.Session.SessionID, principal, miIEntidadDN)
