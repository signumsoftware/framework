...
#Region "Control de ZOOM"
    ...
    ''' <summary>
    ''' Informa de que se ha terminado el zoom y de que los cambios que se hayan realizado
    ''' ya están disponibles en los objetos en memoria
    ''' </summary>
    Public Event ZoomAcabado()

    Private Sub cmdZoom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdZoom.Click
        Try
            '1º hacemos el IUaDN para llevar los cambios a los objetos en memoria
            Me.IUaDNgd()

            '2º lanzamos el evento informando de que ya acaba el zoom
            RaiseEvent ZoomAcabado()
    ...
    Public Property RecuperadorMapeado() As MV2DN.IRecuperadorInstanciaMap
        Get
...
#Region "Métodos de Generación Dinámica"
    ...
    Public Function RecuperarControlDinamico(ByVal pElementoMap As MV2DN.ElementoMapDN) As IctrlDinamico Implements IctrlDinamico.RecuperarControlDinamico
        ...
        'For Each cd As IctrlDinamico In Me.ml
...
#End Region
    ...
    Public Property IGestorPersistencia() As MV2DN.IGestorPersistencia Implements IctrlDinamico.IGestorPersistencia
        Get
            ...
            If mIGestorPersistencia Is Nothing Then
