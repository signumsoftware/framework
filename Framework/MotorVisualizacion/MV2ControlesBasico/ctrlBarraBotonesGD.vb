...
Public Class ctrlBarraBotonesGD
    ...
    Public Sub Poblar(ByVal pColComandoMapDN As MV2DN.ColComandoMapDN)
        ...
        If pColComandoMapDN Is Nothing Then
            Exit Sub
        End If

        Dim ColComandoInstancia As New MV2DN.ColComandoInstancia
        ColComandoInstancia.Poblar(pColComandoMapDN)

        Poblar(ColComandoInstancia)
    End Sub
    ...
    Public ReadOnly Property FlowLayoutPanel() As System.Windows.Forms.FlowLayoutPanel
        Get
            Return Me.FlowLayoutPanel1
        End Get
    End Property
End Class
